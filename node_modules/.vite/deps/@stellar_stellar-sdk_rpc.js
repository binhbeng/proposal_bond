...
//#region proposal-bond-client/node_modules/@stellar/stellar-base/dist/stellar-base.min.js
	...
	(function(e, t) {
		...
		var e = {
			...
			448(e, t, r) {
				...
				const i = n.config(function(e) {
					...
					e.typedef("Value", e.varOpaque()), e.struct("ScpBallot", [["counter", e.lookup("Uint32")], ["value", e.lookup("Value")]]), e.enum("ScpStatementType", {
						...
						["lib", e.string(80)],
						["name", e.string(60)],
						["cases", e.varArray(e.lookup("ScSpecUdtUnionCaseV0"), 50)]
						...
						["lib", e.string(80)],
						["name", e.string(60)],
						["cases", e.varArray(e.lookup("ScSpecUdtEnumCaseV0"), 50)]
						...
						["lib", e.string(80)],
						["name", e.string(60)],
						["cases", e.varArray(e.lookup("ScSpecUdtErrorEnumCaseV0"), 50)]
						...
						["inputs", e.varArray(e.lookup("ScSpecFunctionInputV0"), 10)],
						...
						["params", e.varArray(e.lookup("ScSpecEventParamV0"), 50)],
					...
					}), e.struct("ConfigSettingContractExecutionLanesV0", [["ledgerMaxTxCount", e.lookup("Uint32")]]), e.struct("ConfigSettingContractComputeV0", [
					...
					]), e.const("CONTRACT_COST_COUNT_LIMIT", 1024), e.typedef("ContractCostParams", e.varArray(e.lookup("ContractCostParamEntry"), e.lookup("CONTRACT_COST_COUNT_LIMIT"))), e.enum("ConfigSettingId", {
				...
				function T(e) {
					return e >= b && e <= w ? e - b : e >= S && e <= E ? e - (S - 10) : e >= k && e <= A ? e - (k - 10) : void 0;
				}
				function O(e) {
					...
					for (let t = 0, o = 0; t < r; t++, o += 2) {
						const r = T(e.charCodeAt(o)), i = T(e.charCodeAt(o + 1));
				...
				const J = (() => j([
					...
					"0x5fcb6fab3ad6faec",
					"0x6c44198c4a475817"
				].map((e) => BigInt(e))))(), Q = (() => J[0])(), ee = (() => J[1])(), te = /* @__PURE__ */ new Uint32Array(80), re = /* @__PURE__ */ new Uint32Array(80);
				class ne extends _ {
					constructor(e = 64) {
					...
					process(e, t) {
						...
						for (let e = 16; e < 80; e++) {
							const t = 0 | te[e - 15], r = 0 | re[e - 15], n = V(t, r, 1) ^ V(t, r, 8) ^ M(t, 0, 7), o = q(t, r, 1) ^ q(t, r, 8) ^ D(t, r, 7), i = 0 | te[e - 2], a = 0 | re[e - 2], s = V(i, a, 19) ^ K(i, a, 61) ^ M(i, 0, 6), u = q(i, a, 19) ^ H(i, a, 61) ^ D(i, a, 6), c = G(o, u, re[e - 7], re[e - 16]), l = W(c, n, s, te[e - 7], te[e - 16]);
							te[e] = 0 | l, re[e] = 0 | c;
						}
						let { Ah: r, Al: n, Bh: o, Bl: i, Ch: a, Cl: s, Dh: u, Dl: c, Eh: l, El: f, Fh: p, Fl: d, Gh: h, Gl: y, Hh: m, Hl: g } = this;
						for (let e = 0; e < 80; e++) {
							const t = V(l, f, 14) ^ V(l, f, 18) ^ K(l, f, 41), v = q(l, f, 14) ^ q(l, f, 18) ^ H(l, f, 41), b = l & p ^ ~l & h, w = Y(g, v, f & d ^ ~f & y, ee[e], re[e]), S = Z(w, m, t, b, Q[e], te[e]), E = 0 | w, k = V(r, n, 28) ^ K(r, n, 34) ^ K(r, n, 39), A = q(r, n, 28) ^ H(r, n, 34) ^ H(r, n, 39), T = r & o ^ r & a ^ o & a, O = n & i ^ n & s ^ i & s;
				...
				function Ue(e, t) {
					const r = (e.ORDER + Se) / Ae, n = e.pow(t, r);
					return _e(e, n, t), n;
				}
				function Ne(e, t) {
					const r = (e.ORDER - Te) / xe, n = e.mul(t, Ee), o = e.pow(n, r), i = e.mul(t, o), a = e.mul(e.mul(i, Ee), o), s = e.mul(i, e.sub(a, e.ONE));
					return _e(e, s, t), s;
				}
				function Le(e) {
				...
				function Fe(e) {
					return e % Ae === ke ? Ue : e % xe === Te ? Ne : e % Be === Pe ? function(e) {
				...
				function ft(e, t = {}) {
					...
					const p = be((e, t) => {
						...
						const { X: n, Y: o, Z: a, T: s } = e, c = u(n * n), l = u(o * o), f = u(a * a), p = u(f * f), d = u(c * t);
						if (u(f * u(d + l)) !== u(p + u(r * u(c * l)))) throw new Error("bad point: equation left != right (1)");
					...
					class h {
						...
						static fromBytes(e, t = !1) {
							...
							l[r - 1] = -129 & f;
							const p = le(l), d = t ? s : n.ORDER;
							ye("point.y", p, st, d);
							const y = u(p * p), m = u(y - ut), g = u(a * y - o);
							let { isValid: v, value: b } = c(m, g);
						...
						double() {
							const { a: e } = i, { X: t, Y: r, Z: n } = this, o = u(t * t), a = u(r * r), s = u(ct * u(n * n)), c = u(e * o), l = t + r, f = u(u(l * l) - o - a), p = c + a, d = p - s, y = c - a, m = u(f * d), g = u(p * y), v = u(f * y), b = u(d * p);
							return new h(m, g, b, v);
						}
						add(e) {
							f(e);
							const { a: t, d: r } = i, { X: n, Y: o, Z: a, T: s } = this, { X: c, Y: l, Z: p, T: d } = e, y = u(n * c), m = u(o * l), g = u(s * r * d), v = u(a * p), b = u((n + o) * (c + l) - y - m), w = v - g, S = v + g, E = u(m - t * y), k = u(b * w), A = u(S * E), T = u(b * E), O = u(w * S);
							return new h(k, A, O, T);
						}
						subtract(e) {
				...
				function Tt(e, t) {
					...
					const a = Ie(t * i * i, r), s = i, u = Ie(i * At, r), c = a === e, l = a === Ie(-e, r), f = a === Ie(-e * At, r);
					return c && (i = s), (l || f) && (i = u), je(i, r) && (i = Ie(-i, r)), {
						isValid: c || l,
						value: i
					};
				}
				const Ot = (() => He(St.p, { isLE: !0 }))(), xt = (() => He(St.n, { isLE: !0 }))(), Pt = (() => ({
					...St,
					Fp: Ot,
					hash: oe,
				...
				class Dt extends pt {
					...
					toBytes() {
						...
						const o = wt, i = (e) => Ot.create(e), a = i(i(r + t) * i(r - t)), s = i(e * t), u = i(s * s), { value: c } = Nt(i(a * u)), l = i(c * a), f = i(c * s), p = i(l * f * n);
						let d;
						if (je(n * p, o)) {
				...
				function ir(e) {
					...
					var o = /* @__PURE__ */ new Uint8Array(2);
				...
				}(), Tr = /^-?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?$/i, Or = Math.ceil, xr = Math.floor, Pr = "[BigNumber Error] ", Br = Pr + "Number primitive has more than 15 significant digits: ", Ir = 0x5af3107a4000, Cr = 14, Rr = 9007199254740991, _r = [
					1,
					10,
					100,
					1e3,
				...
				var Hr = function e(t) {
					var r, n, o, i, a, s, u, c, l, f, p = O.prototype = {
						...
						suffix: ""
					}, A = "0123456789abcdefghijklmnopqrstuvwxyz", T = !0;
					function O(e, t) {
						...
						if (null == t) {
							...
							if ((c = "number" == typeof e) && 0 * e == 0) {
								...
								if (!Tr.test(f = String(e))) return o(p, f, c);
							...
							if (Mr(t, 2, A.length, "Base"), 10 == t && T) return I(p = new O(e), h + p.e + 1, y);
							...
							for (r = A.slice(0, t), s = u = 0, l = f.length; u < l; u++) if (r.indexOf(i = f.charAt(u)) < 0) {
								if ("." == i) {
									if (u > s) {
										s = l;
										continue;
					...
					return O.clone = e, O.ROUND_UP = 0, O.ROUND_DOWN = 1, O.ROUND_CEIL = 2, O.ROUND_FLOOR = 3, O.ROUND_HALF_UP = 4, O.ROUND_HALF_DOWN = 5, O.ROUND_HALF_EVEN = 6, O.ROUND_HALF_CEIL = 7, O.ROUND_HALF_FLOOR = 8, O.EUCLID = 9, O.config = O.set = function(e) {
						...
						if (null == e ? e = h : Mr(e, 0, Nr), o = Or(e / Cr), w) if (crypto.getRandomValues) {
							for (t = crypto.getRandomValues(new Uint32Array(o *= 2)); s < o;) (i = 131072 * t[s] + (t[s + 1] >>> 11)) >= 9e15 ? (r = crypto.getRandomValues(/* @__PURE__ */ new Uint32Array(2)), t[s] = r[0], t[s + 1] = r[1]) : (u.push(i % 0x5af3107a4000), s += 2);
							s = o / 2;
						} else {
						...
						return function(n, o, i, a, s) {
							...
							for (v >= 0 && (f = E, E = 0, n = n.replace(".", ""), d = (g = new O(o)).pow(n.length - v), E = f, g.c = t(qr(Fr(d.c), d.e, "0"), 10, i, e), g.e = g.c.length), l = f = (m = t(n, o, i, s ? (u = A, e) : (u = e, A))).length; 0 == m[--f]; m.pop());
						...
						return function(n, o, i, a, s) {
							var u, c, l, f, p, d, h, y, m, g, v, b, w, S, E, k, A, T = n.s == o.s ? 1 : -1, x = n.c, P = o.c;
							if (!(x && x[0] && P && P[0])) return new O(n.s && o.s && (x ? !P || x[0] != P[0] : P) ? x && 0 == x[0] || !P ? 0 * T : T / 0 : NaN);
							for (m = (y = new O(T)).c = [], T = i + (c = n.e - o.e) + 1, s || (s = Ir, c = Lr(n.e / Cr) - Lr(o.e / Cr), T = T / Cr | 0), l = 0; P[l] == (x[l] || 0); l++);
							if (P[l] > (x[l] || 0) && c--, T < 0) m.push(1), f = !0;
							else {
								for (S = x.length, k = P.length, l = 0, T += 2, (p = xr(s / (P[0] + 1))) > 1 && (P = e(P, p, s), x = e(x, p, s), k = P.length, S = x.length), w = k, v = (g = x.slice(0, k)).length; v < k; g[v++] = 0);
								A = P.slice(), A = [0].concat(A), E = P[0], P[1] >= s / 2 && E++;
								do {
									if (p = 0, (u = t(P, g, k, v)) < 0) {
										if (b = g[0], k != v && (b = b * s + (g[1] || 0)), (p = xr(b / E)) > 1) for (p >= s && (p = s - 1), h = (d = e(P, p, s)).length, v = g.length; 1 == t(d, g, h, v);) p--, r(d, k < h ? A : P, h, s), h = d.length, u = 1;
										else 0 == p && (u = p = 1), h = (d = P.slice()).length;
										if (h < v && (d = [0].concat(d)), r(g, d, v, s), v = g.length, -1 == u) for (; t(P, g, k, v) < 1;) p++, r(g, k < v ? A : P, v, s), v = g.length;
									} else 0 === u && (p++, g = [0]);
									m[l++] = p, g[0] ? g[v++] = x[w] || 0 : (g = [x[w]], v = 1);
								} while ((w++ < S || null != g[0]) && T--);
						...
						return null === i ? o ? (t = "Infinity", o < 0 && (t = "-" + t)) : t = "NaN" : (null == e ? t = i <= m || i >= g ? Vr(Fr(r.c), i) : qr(Fr(r.c), i, "0") : 10 === e && T ? t = qr(Fr((r = I(new O(r), h + i + 1, y)).c), r.e, "0") : (Mr(e, 2, A.length, "Base"), t = n(qr(Fr(r.c), i, "0"), 10, e, o, !0)), o < 0 && r.c[0] && (t = "-" + t)), t;
				...
				var Hn = "none", zn = "id", Xn = "text", $n = "hash", Gn = "return", Wn = function() {
					...
					return function(e, t, r) {
					...
					], [
						{
							...
							value: function(e) {
								var t, r = new Error("Expects a int64 as a string. Got ".concat(e));
				...
				var Oo = function() {
					return function(e, t, r) {
						return t && Ao(e.prototype, t), r && Ao(e, r), Object.defineProperty(e, "prototype", { writable: !1 }), e;
					}(function e(t) {
						var r;
						(function(e, t) {
							if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
						})(this, e), function(e, t, r) {
							(t = To(t)) in e ? Object.defineProperty(e, t, {
								value: r,
								enumerable: !0,
								configurable: !0,
								writable: !0
				...
				var Ti = function(e) {
					function t(e, r) {
						...
						var o = e < 0, i = null !== (n = null == r ? void 0 : r.type) && void 0 !== n ? n : "";
						if (i.startsWith("u") && o) throw TypeError("specified type ".concat(r.type, " yet negative (").concat(e, ")"));
						if ("" === i) {
							i = o ? "i" : "u";
							var a = function(e) {
							...
							switch (a) {
								...
								case 256:
									i += a.toString();
									break;
								default: throw RangeError("expected 64/128/256 bits for input (".concat(e, "), got ").concat(a));
							}
						}
						return Si(this, t, [i, e]);
					}
					return function(e, t) {
						if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
						e.prototype = Object.create(t && t.prototype, { constructor: {
							...
							writable: !0,
							configurable: !0
						} }), Object.defineProperty(e, "prototype", { writable: !1 }), t && Ai(e, t);
					}(t, e), function(e, t, r) {
				...
				function _i(e) {
					...
					switch (Ri(e)) {
						...
						case "bigint":
							...
							return new Ti(e, { type: null == t ? void 0 : t.type }).toScVal();
						case "string":
					...
					return function(e, t, r) {
					...
					], [
						{
							...
							value: function(t) {
								...
								var n, o = (BigInt(t.sequence) - 1n).toString();
								if (tr.isValidMed25519PublicKey(t.source)) n = Eo.fromAddress(t.source, o);
								else {
									if (!tr.isValidEd25519PublicKey(t.source)) throw new TypeError("unsupported tx source account: ".concat(t.source));
									n = new vo(t.source, o);
								}
								var i = new e(n, Mi({
									fee: (parseInt(t.fee, 10) / t.operations.length || Ki).toString(),
									memo: t.memo,
				...
				function pa(e, t, r) {
					var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "", o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : $i.FUTURENET, a = lr.random().rawPublicKey(), s = new i.Int64(a.subarray(0, 8).reduce(function(e, t) {
						return e << 8 | t;
					}, 0)), u = n || e.publicKey();
					if (!u) throw new Error("authorizeInvocation requires publicKey parameter");
			...
			453(e, t, r) {
				...
				var n, o = r(9612), i = r(9383), a = r(1237), s = r(9290), u = r(9538), c = r(8068), l = r(9675), f = r(5345), p = r(1514), d = r(8968), h = r(6188), y = r(8002), m = r(5880), g = r(414), v = r(3093), b = Function, w = function(e) {
				...
				}() : k, T = r(4039)(), O = r(3628), x = r(1064), P = r(8648), B = r(1002), I = r(76), C = {}, R = "undefined" != typeof Uint8Array && O ? O(Uint8Array) : n, _ = {
					__proto__: null,
					"%AggregateError%": "undefined" == typeof AggregateError ? n : AggregateError,
					"%Array%": Array,
					"%ArrayBuffer%": "undefined" == typeof ArrayBuffer ? n : ArrayBuffer,
					"%ArrayIteratorPrototype%": T && O ? O([][Symbol.iterator]()) : n,
					...
					"%isFinite%": isFinite,
					"%isNaN%": isNaN,
					"%IteratorPrototype%": T && O ? O(O([][Symbol.iterator]())) : n,
					"%JSON%": "object" == typeof JSON ? JSON : n,
					"%Map%": "undefined" == typeof Map ? n : Map,
					"%MapIteratorPrototype%": "undefined" != typeof Map && T && O ? O((/* @__PURE__ */ new Map())[Symbol.iterator]()) : n,
					"%Math%": Math,
					"%Number%": Number,
					"%Object%": o,
					...
					"%SetIteratorPrototype%": "undefined" != typeof Set && T && O ? O((/* @__PURE__ */ new Set())[Symbol.iterator]()) : n,
					"%SharedArrayBuffer%": "undefined" == typeof SharedArrayBuffer ? n : SharedArrayBuffer,
					"%String%": String,
					"%StringIteratorPrototype%": T && O ? O(""[Symbol.iterator]()) : n,
					"%Symbol%": T ? Symbol : n,
					"%SyntaxError%": c,
					"%ThrowTypeError%": A,
					"%TypedArray%": R,
			...
			537(e, t, r) {
				...
				function d(e, r, n) {
					...
					if (e.showHidden && (a = Object.getOwnPropertyNames(r)), T(r) && (a.indexOf("message") >= 0 || a.indexOf("description") >= 0)) return h(r);
					if (0 === a.length) {
						if (O(r)) {
							var u = r.name ? ": " + r.name : "";
					...
					return E(r) && (l = " " + RegExp.prototype.toString.call(r)), A(r) && (l = " " + Date.prototype.toUTCString.call(r)), T(r) && (l = " " + h(r)), 0 !== a.length || f && 0 != r.length ? n < 0 ? E(r) ? e.stylize(RegExp.prototype.toString.call(r), "regexp") : e.stylize("[Object]", "special") : (e.seen.push(r), c = f ? function(e, t, r, n, o) {
				...
				}, t.isUndefined = S, t.isRegExp = E, t.types.isRegExp = E, t.isObject = k, t.isDate = A, t.types.isDate = A, t.isError = T, t.types.isNativeError = T, t.isFunction = O, t.isPrimitive = function(e) {
				...
				function N(e, t, r, n) {
					...
					if (b(e)) {
						...
						if (g(e)) {
							...
							return T(e) ? T(t) && c(Number.prototype.valueOf.call(e), Number.prototype.valueOf.call(t)) : O(e) ? O(t) && String.prototype.valueOf.call(e) === String.prototype.valueOf.call(t) : x(e) ? x(t) && Boolean.prototype.valueOf.call(e) === Boolean.prototype.valueOf.call(t) : P(e) ? P(t) && BigInt.prototype.valueOf.call(e) === BigInt.prototype.valueOf.call(t) : B(t) && Symbol.prototype.valueOf.call(e) === Symbol.prototype.valueOf.call(t);
						}(e, t)) return !1;
					}
					return F(e, t, r, n, 0);
				}
			...
			2890(e, t, r) {
				...
				n(u, o), u.prototype.init = function() {
					...
					for (var t = this._w, r = 0 | this._ah, n = 0 | this._bh, o = 0 | this._ch, i = 0 | this._dh, s = 0 | this._eh, u = 0 | this._fh, v = 0 | this._gh, b = 0 | this._hh, w = 0 | this._al, S = 0 | this._bl, E = 0 | this._cl, k = 0 | this._dl, A = 0 | this._el, T = 0 | this._fl, O = 0 | this._gl, x = 0 | this._hl, P = 0; P < 32; P += 2) t[P] = e.readInt32BE(4 * P), t[P + 1] = e.readInt32BE(4 * P + 4);
					for (; P < 160; P += 2) {
				...
				n = () => (() => {
					var e = {
						616: (e, t, r) => {
							...
							r.d(t, { A: () => o });
							var n = r(287);
							n.hp.alloc(1).subarray(0, 1) instanceof n.hp || (n.hp.prototype.subarray = function(e, t) {
								const r = Uint8Array.prototype.subarray.call(this, e, t);
						...
						164: (e, t, r) => {
							...
							class d {
								toXDR(e = "raw") {
									...
									const t = new f();
									return this.write(this, t), g(t.finalize(), e);
								}
								fromXDR(e, t = "raw") {
									if (!this.read) return this.constructor.fromXDR(e, t);
									const r = new u(v(e, t)), n = this.read(r);
								...
								static toXDR(e, t = "raw") {
									const r = new f();
									return this.write(e, r), g(r.finalize(), t);
								}
							...
							function b(e, t) {
								return null != e && (e instanceof t || w(e, t) && "function" == typeof e.constructor.read && "function" == typeof e.constructor.write && w(e, "XdrType"));
							}
							function w(e, t) {
								do
							...
							class E extends h {
								...
								static isValid(e) {
									return "number" == typeof e && (0 | e) === e && e >= -2147483648 && e <= S;
								}
							}
							function k(e, t, r) {
							...
							class T extends h {
								constructor(e) {
									super(), this._value = function(e, t, r) {
										...
										if (r && 1 === e.length && e[0] < 0n) throw new RangeError(`expected a positive value, got: ${e}`);
										let o = BigInt.asUintN(n, e[0]);
										for (let t = 1; t < e.length; t++) o |= BigInt.asUintN(n, e[t]) << BigInt(t * n);
										r || (o = BigInt.asIntN(t, o));
										const [i, a] = A(t, r);
										if (o >= i && o <= a) return o;
										throw new TypeError(`bigint values [${e}] for ${function(e, t) {
											return `${t ? "u" : "i"}${e}`;
										}(t, r)} out of range [${i}, ${a}]: ${o}`);
								...
								slice(e) {
									return k(this._value, this.size, e);
								}
								toString() {
								...
								static read(e) {
									const { size: t } = this.prototype;
									return 64 === t ? new this(e.readBigUInt64BE()) : new this(...Array.from({ length: t / 64 }, () => e.readBigUInt64BE()).reverse());
								}
								static write(e, t) {
									...
									else for (const n of k(e, o, 64).reverse()) r ? t.writeBigUInt64BE(n) : t.writeBigInt64BE(n);
								}
								static isValid(e) {
									return "bigint" == typeof e || e instanceof this;
								}
								static fromString(e) {
									return new this(e);
								}
							...
							class P extends h {
								...
								static write(e, t) {
									if ("number" != typeof e || !(e >= 0 && e <= x) || e % 1 != 0) throw new n("invalid u32 value");
									t.writeUInt32BE(e);
								}
								static isValid(e) {
									return "number" == typeof e && e % 1 == 0 && e >= 0 && e <= x;
								}
							}
							...
							class N extends y {
								...
								write(e, t) {
									const r = "string" == typeof e ? U.byteLength(e, "utf8") : e.length;
									if (r > this._maxLength) throw new n(`got ${e.length} bytes, max allowed is ${this._maxLength}`);
									P.write(r, t), t.write(e, r);
								}
								isValid(e) {
									return "string" == typeof e ? U.byteLength(e, "utf8") <= this._maxLength : !!(e instanceof Array || U.isBuffer(e)) && e.length <= this._maxLength;
								}
							}
							var L = r(616).A;
							class F extends y {
								...
								isValid(e) {
									return L.isBuffer(e) && e.length === this._length;
								}
							}
							var j = r(616).A;
							class M extends y {
								...
								isValid(e) {
									return j.isBuffer(e) && e.length <= this._maxLength;
								}
							}
							class D extends y {
								constructor(e, t) {
									super(), this._childType = e, this._length = t;
								}
								read(e) {
									const t = new r.g.Array(this._length);
									for (let r = 0; r < this._length; r++) t[r] = this._childType.read(e);
									return t;
								}
								write(e, t) {
							...
							class V extends y {
								constructor(e, t = P.MAX_VALUE) {
									super(), this._childType = e, this._maxLength = t;
								}
								read(e) {
									const t = P.read(e);
									if (t > this._maxLength) throw new o(`saw ${t} length VarArray, max allowed is ${this._maxLength}`);
									const r = new Array(t);
									for (let n = 0; n < t; n++) r[n] = this._childType.read(e);
									return r;
								}
								write(e, t) {
							...
							class q extends h {
								constructor(e) {
									super(), this._childType = e;
								}
								read(e) {
									if (_.read(e)) return this._childType.read(e);
								}
								write(e, t) {
									const r = null != e;
									_.write(r, t), r && this._childType.write(e, t);
								}
								isValid(e) {
							...
							class H extends h {
								...
								static read(e) {
									const t = E.read(e), r = this._byValue[t];
								...
								static isValid(e) {
									return e?.constructor?.enumName === this.enumName || b(e, this);
								}
								static members() {
							...
							class X extends y {
								constructor(e) {
									super(), this._attributes = e || {};
								}
								static read(e) {
									const t = {};
									for (const [r, n] of this._fields) t[r] = n.read(e);
									return new this(t);
								}
								static write(e, t) {
								...
								static isValid(e) {
									return e?.constructor?.structName === this.structName || b(e, this);
								}
								static create(e, t, r) {
									const n = class extends X {};
									n.structName = t, e.results[t] = n;
									const o = new Array(r.length);
									for (let t = 0; t < r.length; t++) {
										const i = r[t], a = i[0];
										let s = i[1];
										s instanceof z && (s = s.resolve(e)), o[t] = [a, s], n.prototype[a] = $(a);
									}
									return n._fields = o, n;
								}
							}
							function $(e) {
								return function(t) {
							...
							class G extends y {
								...
								set(e, t) {
									...
									this._arm = r, this._armType = r === K ? K : this.constructor._arms[r], this._value = t;
								}
								get(e = this._arm) {
									if (this._arm !== K && this._arm !== e) throw new TypeError(`${e} not set`);
									return this._value;
								}
								switch() {
									return this._switch;
								...
								static armTypeForArm(e) {
									return e === K ? K : this._arms[e];
								}
								static read(e) {
									const t = this._switchOn.read(e), r = this.armForSwitch(t), n = r === K ? K : this._arms[r];
									let o;
									return o = void 0 !== n ? n.read(e) : r.read(e), new this(t, o);
								}
								static write(e, t) {
								...
								static isValid(e) {
									return e?.constructor?.unionName === this.unionName || b(e, this);
								}
								static create(e, t, r) {
									const n = class extends G {};
									n.unionName = t, e.results[t] = n, r.switchOn instanceof z ? n._switchOn = r.switchOn.resolve(e) : n._switchOn = r.switchOn, n._switches = /* @__PURE__ */ new Map(), n._arms = {};
									let o = r.defaultArm;
									o instanceof z && (o = o.resolve(e)), n._defaultArm = o;
									for (const [e, t] of r.switches) {
										const r = "string" == typeof e ? n._switchOn.fromName(e) : e;
										n._switches.set(r, t);
									}
									if (void 0 !== n._switchOn.values) for (const e of n._switchOn.values()) n[e.name] = function(t) {
										return new n(e, t);
									}, n.prototype[e.name] = function(t) {
										return this.set(e, t);
									};
									if (r.arms) for (const [t, o] of Object.entries(r.arms)) n._arms[t] = o instanceof z ? o.resolve(e) : o, o !== K && (n.prototype[t] = function() {
										return this.get(t);
									});
									return n;
								}
							...
							class Y extends z {
								...
								resolve(e) {
									...
									return t instanceof z && (t = t.resolve(e)), r instanceof z && (r = r.resolve(e)), this.variable ? new V(t, r) : new D(t, r);
								}
							}
							class Z extends z {
								constructor(e) {
								...
								resolve(e) {
									...
									return t instanceof z && (t = t.resolve(e)), new q(t);
								}
							}
							class J extends z {
								constructor(e, t) {
								...
								resolve(e) {
									let t = this.length;
									return t instanceof z && (t = t.resolve(e)), new this.sizedType(t);
								}
							}
							class Q {
								constructor(e, t, r) {
							...
							function ee(e, t, r) {
								return r instanceof z && (r = r.resolve(e)), e.results[t] = r, r;
							}
							function te(e, t, r) {
							...
							class re {
								...
								enum(e, t) {
									const r = new Q(H.create, e, t);
									this.define(e, r);
								}
								struct(e, t) {
									const r = new Q(X.create, e, t);
									this.define(e, r);
								}
								union(e, t) {
									const r = new Q(G.create, e, t);
									this.define(e, r);
								}
								typedef(e, t) {
									const r = new Q(ee, e, t);
									this.define(e, r);
								}
								const(e, t) {
									const r = new Q(te, e, t);
									this.define(e, r);
								}
								void() {
									return K;
						...
						287: (e, t, r) => {
							"use strict";
							const n = r(526), i = r(251), a = "function" == typeof Symbol && "function" == typeof Symbol.for ? Symbol.for("nodejs.util.inspect.custom") : null;
							t.hp = c, t.IS = 50;
							const s = 2147483647;
							function u(e) {
							...
							c.TYPED_ARRAY_SUPPORT = function() {
								try {
									const e = /* @__PURE__ */ new Uint8Array(1), t = { foo: function() {
										return 42;
									} };
								...
								for (;;) switch (n) {
									...
									case "ucs-2":
									case "utf16le":
									case "utf-16le": return T(this, e, t, r);
									default:
			...
			3918(e, t, r) {
				...
				function x(e, t, r) {
					...
					if ("strictEqual" === r && "object" === m(e) && "object" === m(t) && null !== e && null !== t && (r = "strictEqualObject"), 1 === l.length && 1 === f.length && l[0] !== f[0]) {
						...
						if (h <= 10) {
							if (!("object" === m(e) && null !== e || "object" === m(t) && null !== t || 0 === e && 0 === t)) return "".concat(A[r], "\n\n") + "".concat(l[0], " !== ").concat(f[0], "\n");
					...
					if (0 === v) {
						var T = c.split("\n");
						if (T.length > 30) for (T[26] = "".concat(w, "...").concat(k); T.length > 27;) T.pop();
				...
				e.exports = function(e, t) {
					...
					function b(e) {
						...
						else if (n.stderr && n.stderr.isTTY && (n.stderr && n.stderr.getColorDepth && 1 !== n.stderr.getColorDepth() ? (w = "\x1B[34m", S = "\x1B[32m", k = "\x1B[39m", E = "\x1B[31m") : (w = "", S = "", k = "", E = "")), "object" === m(a) && null !== a && "object" === m(s) && null !== s && "stack" in a && a instanceof Error && "stack" in s && s instanceof Error && (a = T(a), s = T(s)), "deepStrictEqual" === o || "strictEqual" === o) t = p.call(this, x(a, s, o));
						else if ("notDeepStrictEqual" === o || "notStrictEqual" === o) {
							var f = A[o], d = O(a).split("\n");
							if ("notStrictEqual" === o && "object" === m(a) && null !== a && (f = A.notStrictEqualObject), d.length > 30) for (d[26] = "".concat(w, "...").concat(k); d.length > 27;) d.pop();
							t = 1 === d.length ? p.call(this, "".concat(f, " ").concat(d[0])) : p.call(this, "".concat(f, "\n\n").concat(d.join("\n"), "\n"));
						} else {
							var h = O(a), y = "", g = A[o];
							"notDeepEqual" === o || "notEqual" === o ? (h = "".concat(A[o], "\n\n").concat(h)).length > 1024 && (h = "".concat(h.slice(0, 1021), "...")) : (y = "".concat(O(s)), h.length > 512 && (h = "".concat(h.slice(0, 509), "...")), y.length > 512 && (y = "".concat(y.slice(0, 509), "...")), "deepEqual" === o || "equal" === o ? h = "".concat(g, "\n\n").concat(h, "\n\nshould equal\n\n") : y = " ".concat(o, " ").concat(y)), t = p.call(this, "".concat(h).concat(y));
						}
			...
			4148(e, t, r) {
				...
				var c, l, f = r(9597).codes, p = f.ERR_AMBIGUOUS_ARGUMENT, d = f.ERR_INVALID_ARG_TYPE, h = f.ERR_INVALID_ARG_VALUE, y = f.ERR_INVALID_RETURN_VALUE, m = f.ERR_MISSING_ARGS, g = r(3918), v = r(537).inspect, b = r(537).types, w = b.isPromise, S = b.isRegExp, E = r(9133)(), k = r(9394)(), A = r(8075)("RegExp.prototype.test");
				function T() {
					var e = r(2299);
				...
				var R = s(function e(t, r, n) {
					...
					(function(e, t) {
						...
						e in t && (void 0 !== n && "string" == typeof n[e] && S(t[e]) && A(t[e], n[e]) ? o[e] = n[e] : o[e] = t[e]);
					});
				});
				function _(e, t, r, n) {
					if ("function" != typeof t) {
						...
						return void 0 === c && T(), a.forEach(function(o) {
							"string" == typeof e[o] && S(t[o]) && A(t[o], e[o]) || function(e, t, r, n, o, i) {
								if (!(r in e) || !l(e[r], t[r])) {
									if (!n) {
										var u = new g({
											actual: new R(e, o),
			...
			9032(e, t, r) {
				...
				t.isArgumentsObject = n, t.isGeneratorFunction = o, t.isTypedArray = a, t.isPromise = function(e) {
					...
					return w(e);
				}, S.working = "undefined" != typeof ArrayBuffer && S(/* @__PURE__ */ new ArrayBuffer()), t.isArrayBuffer = E, k.working = "undefined" != typeof ArrayBuffer && "undefined" != typeof DataView && k(new DataView(/* @__PURE__ */ new ArrayBuffer(1), 0, 1)), t.isDataView = A;
				var T = "undefined" != typeof SharedArrayBuffer ? SharedArrayBuffer : void 0;
				function O(e) {
					return "[object SharedArrayBuffer]" === l(e);
				}
				function x(e) {
					return void 0 !== T && (void 0 === O.working && (O.working = O(new T())), O.working ? O(e) : e instanceof T);
				}
				function P(e) {
					return m(e, f);
				}
...
//#endregion
//#region proposal-bond-client/node_modules/@stellar/stellar-sdk/lib/rpc/api.js
...
//#endregion
//#region proposal-bond-client/node_modules/urijs/src/punycode.js
...
//#endregion
//#region proposal-bond-client/node_modules/urijs/src/IPv6.js
...
//#endregion
//#region proposal-bond-client/node_modules/urijs/src/SecondLevelDomains.js
...
//#endregion
//#region proposal-bond-client/node_modules/urijs/src/URI.js
...
//#endregion
//#region proposal-bond-client/node_modules/@stellar/stellar-sdk/lib/http-client/types.js
...
//#endregion
//#region proposal-bond-client/node_modules/axios/dist/browser/axios.cjs
...
//#endregion
//#region proposal-bond-client/node_modules/@stellar/stellar-sdk/lib/http-client/axios-client.js
...
//#endregion
//#region proposal-bond-client/node_modules/@stellar/stellar-sdk/lib/http-client/index.js
...
//#endregion
//#region proposal-bond-client/node_modules/@stellar/stellar-sdk/lib/rpc/axios.js
...
//#endregion
//#region proposal-bond-client/node_modules/@stellar/stellar-sdk/lib/rpc/jsonrpc.js
...
//#endregion
//#region proposal-bond-client/node_modules/@stellar/stellar-sdk/lib/rpc/parsers.js
var require_parsers = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function parseSuccessful(sim, partial) {
		...
		}, ((_sim$results$length = (_sim$results = sim.results) === null || _sim$results === void 0 ? void 0 : _sim$results.length) !== null && _sim$results$length !== void 0 ? _sim$results$length : false) && { result: sim.results.map(function(row) {
			var _row$auth;
			return {
		...
		})[0] }), ((_sim$stateChanges$len = (_sim$stateChanges = sim.stateChanges) === null || _sim$stateChanges === void 0 ? void 0 : _sim$stateChanges.length) !== null && _sim$stateChanges$len !== void 0 ? _sim$stateChanges$len : false) && { stateChanges: (_sim$stateChanges2 = sim.stateChanges) === null || _sim$stateChanges2 === void 0 ? void 0 : _sim$stateChanges2.map(function(entryChange) {
			return {
...
//#endregion
//#region proposal-bond-client/node_modules/@stellar/stellar-sdk/lib/rpc/transaction.js
...
//#endregion
//#region proposal-bond-client/node_modules/@stellar/stellar-sdk/lib/utils.js
...
//#endregion
//#region proposal-bond-client/node_modules/@stellar/stellar-sdk/lib/rpc/server.js
					...
					var _getLatestLedger = _asyncToGenerator(_regenerator().m(function _callee17() {
						return _regenerator().w(function(_context17) {
							while (1) switch (_context17.n) {
								case 0: return _context17.a(2, jsonrpc.postObject(this.httpClient, this.serverURL.toString(), "getLatestLedger"));
							}
						}, _callee17, this);
					}));
					...
					var _simulateTransaction2 = _asyncToGenerator(_regenerator().m(function _callee18(tx, addlResources, authMode) {
						return _regenerator().w(function(_context18) {
							while (1) switch (_context18.n) {
								case 0: return _context18.a(2, this._simulateTransaction(tx, addlResources, authMode).then(_parsers.parseRawSimulation));
							}
						}, _callee18, this);
					}));
					...
					var _simulateTransaction3 = _asyncToGenerator(_regenerator().m(function _callee19(transaction, addlResources, authMode) {
						return _regenerator().w(function(_context19) {
							while (1) switch (_context19.n) {
								case 0: return _context19.a(2, jsonrpc.postObject(this.httpClient, this.serverURL.toString(), "simulateTransaction", _objectSpread({
					...
					var _prepareTransaction = _asyncToGenerator(_regenerator().m(function _callee20(tx) {
						...
						return _regenerator().w(function(_context20) {
							while (1) switch (_context20.n) {
								...
								case 2: return _context20.a(2, (0, _transaction.assembleTransaction)(tx, simResponse).build());
							}
						}, _callee20, this);
					}));
					...
					var _sendTransaction2 = _asyncToGenerator(_regenerator().m(function _callee21(transaction) {
						return _regenerator().w(function(_context21) {
							while (1) switch (_context21.n) {
								case 0: return _context21.a(2, this._sendTransaction(transaction).then(_parsers.parseRawSendTransaction));
							}
						}, _callee21, this);
					}));
					...
					var _sendTransaction3 = _asyncToGenerator(_regenerator().m(function _callee22(transaction) {
						return _regenerator().w(function(_context22) {
							while (1) switch (_context22.n) {
								case 0: return _context22.a(2, jsonrpc.postObject(this.httpClient, this.serverURL.toString(), "sendTransaction", { transaction: transaction.toXDR() }));
							}
						}, _callee22, this);
					}));
					...
					var _requestAirdrop = _asyncToGenerator(_regenerator().m(function _callee23(address, friendbotUrl) {
						...
						return _regenerator().w(function(_context23) {
							while (1) switch (_context23.p = _context23.n) {
								...
								case 1: _t6 = _context23.v.friendbotUrl;
								case 2:
									friendbotUrl = _t6;
									if (friendbotUrl) {
										_context23.n = 3;
						...
						return _regenerator().w(function(_context24) {
							while (1) switch (_context24.p = _context24.n) {
								...
								case 1:
									...
									_context24.n = 2;
									return this.getNetwork();
								case 2: _t8 = _context24.v.friendbotUrl;
								case 3:
									friendbotUrl = _t8;
									if (friendbotUrl) {
										_context24.n = 4;
								...
								case 7: return _context24.a(2, txResponse);
								case 8:
									_context24.p = 8;
									_t9 = _context24.v;
					...
					var _getFeeStats = _asyncToGenerator(_regenerator().m(function _callee25() {
						return _regenerator().w(function(_context25) {
							while (1) switch (_context25.n) {
								case 0: return _context25.a(2, jsonrpc.postObject(this.httpClient, this.serverURL.toString(), "getFeeStats"));
							}
						}, _callee25, this);
					}));
					...
					var _getVersionInfo = _asyncToGenerator(_regenerator().m(function _callee26() {
						return _regenerator().w(function(_context26) {
							while (1) switch (_context26.n) {
								case 0: return _context26.a(2, jsonrpc.postObject(this.httpClient, this.serverURL.toString(), "getVersionInfo"));
							}
						}, _callee26, this);
					}));
					...
					var _getLedgers2 = _asyncToGenerator(_regenerator().m(function _callee28(request) {
						return _regenerator().w(function(_context28) {
							while (1) switch (_context28.n) {
								case 0: return _context28.a(2, this._getLedgers(request).then(function(raw) {
									return {
					...
					var _getLedgers3 = _asyncToGenerator(_regenerator().m(function _callee29(request) {
						return _regenerator().w(function(_context29) {
							while (1) switch (_context29.n) {
								case 0: return _context29.a(2, jsonrpc.postObject(this.httpClient, this.serverURL.toString(), "getLedgers", request));
							}
						}, _callee29, this);
					}));
...
//#endregion
//#region proposal-bond-client/node_modules/@stellar/stellar-sdk/lib/rpc/index.js
...
export { require_stellar_base_min as i, require_transaction as n, require_api as r, require_rpc as t };
